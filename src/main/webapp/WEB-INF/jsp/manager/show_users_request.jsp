...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="col-12 d-flex justify-content-center">
        <div>
            <button class="btn btn-primary my-2 my-sm-0" onclick="showUsersRequest()">Show user request reports</button>
        </div>
    </div>
</nav>
<br><br>
            ...
            <div class="col-12">
                <table class="table table-bordered table-striped text-dark text-center" style="margin-left: -4%">
                    ...
                    <tr>
                        ...
                        <th>
                            count of request registered
                        </th>
                    </tr>
                    </thead>
                    <tbody id="response-requests">
