...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="col-12 d-flex justify-content-center">
        <div>
            <button class="btn btn-primary my-2 my-sm-0" onclick="getCustomerServices()">Customer Services</button>
            <button class="btn btn-primary my-2 my-sm-0" onclick="getExpertServices()">Expert Services</button>
        </div>
    </div>
</nav>
<br><br>
